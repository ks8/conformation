...
from conformation.flows import NormalizingFlowModel, CNFFlowModel
...
def build_model_cnf(args: Namespace) -> NormalizingFlowModel:
    """
    Function to build a RealNVP normalizing flow.
    :param args: System parameters.
    :return: nn.Module defining the normalizing flow.
    ...
    return CNFFlowModel(base_dist_func, biject)
