...
from conformation.sample_cnf import sample
...
def run_sampling(args: Namespace) -> None:
    ...
    if args.checkpoint_path is not None:
        ...
        model = build_model_cnf(loaded_args)
        ...
        sample(model, args.smiles, args.save_dir, args.num_atoms, args.offset, args.num_layers, args.num_samples,
               args.dihedral, args.dihedral_vals, args.condition_path)
...
def main():
    ...
    parser.add_argument('--condition_path', type=str, dest='condition_path',
                        default=None, help='Directory of condition')
