...
class Args(Tap):
    ...
    thread_set: bool = False  # Set max number of threads
        ...
        for f in files:
            ...
            for j in range(args.num_starts):
                ...
                try:
                    ...
                    with open(
                            os.path.join(args.save_dir, molecule_name + "_" + ("{:0" + str(len(str(args.num_starts))) +
                        ...
                        while line:
                            ...
                            if line.split()[1] == molecule_name:
                                if not new_file:
                                    ...
                                    # Compute pairwise distance matrix and save to a numpy file in the "distmat" folder
                                    dist_matrix(pos,
                                                os.path.join(args.save_dir, "distmat", "distmat-" + str(counter) + "-"
                                                             + molecule_name))
